...
extern "C" {
#endif
void Render_text(const char * text,int font_size,int font,SDL_Renderer *renderer,int x,int y,SDL_Color textColor);
...
const char * font_address_01="C:\\function\\font\\arial.ttf";
...
{
    Render_text(text, font_size, font, renderer, x, y, textColor);
}
